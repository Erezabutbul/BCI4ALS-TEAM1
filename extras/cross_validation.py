...
from extras.localVote import main as vote
# import os
# import pandas as pd
...
def main(channels):
    ...
    for i in range(100):
        ...
        full_X = pd.read_csv(train_features_folder_path + "newFeatures.csv", header=None)
        # print(full_X)
        ...
        ####################################################################
        label_vec = np.loadtxt(train_features_folder_path + "newLabels.csv")
        # print(result_df)
        # Remove the rows
