...
df_target = pd.read_csv('output_files/EEG_Recordings/Mean_EEG_Signal_class_target_27_12_2022 at 01_03_32_PM_ErezFirstRecordMEANED.csv')
df_baseline = pd.read_csv('output_files/EEG_Recordings/Mean_EEG_Signal_class_baseLine_27_12_2022 at 01_03_32_PM_ErezFirstRecordMEANED.csv')
df_distractor = pd.read_csv('output_files/EEG_Recordings/Mean_EEG_Signal_class_distractor_27_12_2022 at 01_03_32_PM_ErezFirstRecordMEANED.csv')

time = pd.DataFrame(np.linspace(0, 75/125, 75))  # 75 samples, fs=125Hz
